  ...
  <aside class="w-72 bg-dark-900 border-r border-dark-800 flex flex-col h-screen">
    ...
    <div class="p-2 border-t border-dark-800">
      ...
      <router-link
        to="/analytics"
        class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition"
        :class="$route.name === 'analytics' ? 'bg-dark-800 text-white' : 'text-dark-400 hover:bg-dark-800/50 hover:text-dark-200'"
      >
        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
          <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 3.75c0-.621.504-1.125 1.125-1.125h2.25C20.496 2.25 21 2.754 21 3.375v16.5c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V3.75z" />
        </svg>
        Usage
      </router-link>
    </div>
