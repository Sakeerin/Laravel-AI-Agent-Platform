  ...
  <div class="min-h-screen bg-dark-950 flex items-center justify-center px-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-bold text-white">AI Agent Platform</h1>
        <p class="text-dark-400 mt-2">Sign in to start chatting</p>
      </div>

      <form @submit.prevent="handleLogin" class="bg-dark-900 rounded-2xl p-8 border border-dark-800">
        ...
        <p class="text-center text-dark-400 mt-6 text-sm">
          ...
          <router-link to="/register" class="text-primary-400 hover:text-primary-300 font-medium">Create one</router-link>
        </p>
      </form>
    </div>
  </div>
